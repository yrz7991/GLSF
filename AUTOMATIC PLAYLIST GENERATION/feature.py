...
path = r"D:\Master Engineering Program\AUTOMATIC PLAYLIST GENERATION\AUTOMATIC PLAYLIST GENERATION\AUTOMATIC PLAYLIST GENERATION\music_compare\r_7"
...
for filename in file_path:
    num = num + 1
    path_filename = os.path.join("./music_compare/r_7", filename)  # ./代表本目录
